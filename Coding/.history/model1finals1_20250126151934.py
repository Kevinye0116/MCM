...
class ImprovedTourismOptimizer:
    ...
    def calculate_investments(self, Nt, tau_t, k5, k6, k7):
        ...
        Re = self.Pt * Nt * (1 - tau_t)  # 考虑税收影响
        P_waste = k5 * tau_t * Re
        P_water = k6 * tau_t * Re
        P_e = k7 * tau_t * Re
        return P_waste, P_water, P_e, Re
    ...
    def objective(self, x):
        ...
        P_waste, P_water, P_e, Re = self.calculate_investments(Nt, tau_t, k5, k6, k7)
        Re = Re / self.Restandrand  # 归一化收入
