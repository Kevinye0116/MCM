...
from pymoo.util.hv import Hypervolume  # 添加正确的超体积计算类导入
...
def sensitivity_analysis(
    ...
    # 生成参数样本（Sobol序列）- 使用更新后的sobol采样器
    from SALib.sample import sobol  # 替换为新的sobol采样器
