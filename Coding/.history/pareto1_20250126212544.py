...
class TourismOptimizer:
    def __init__(self):
        ...
        self.K4 = 0.01  # Social satisfaction coefficient
        self.ALPHA1 = 0.0001  # Waste management efficiency
        self.ALPHA2 = 0.0005  # Water management efficiency
        self.ALPHA3 = 0.0005  # Environmental management efficiency
        self.Pt = 190  # Fixed average spending per tourist

        # Constraints
        self.N_MAX = 3000000  # Maximum daily tourists
        self.CO2_MAX = 320000  # Maximum carbon emissions per person
