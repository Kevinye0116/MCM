...
class ImprovedTourismOptimizer:
    ...
    def analyze_solution(self, result):
        ...
        Cbase = self.Cbase + self.alpha1 * P_e
        Cwaste = self.Cwaste + self.alpha2 * P_waste
        Cwater = self.Cwater + self.alpha2 * P_water
        ...
        print(f"Environmental Quality Index (E): {E:.4f}")
    ...
    def visualize_sensitivity(self, Si, problem):
    ...
    def perform_sensitivity_analysis(self, n_samples=1024):
        ...
        # 将problem作为参数传递给visualize_sensitivity
        self.visualize_sensitivity(Si, problem)
...
def main():
    ...
    # Perform sensitivity analysis with visualization
