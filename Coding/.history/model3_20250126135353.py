...
class TourismOptimizer:
    def __init__(self):
        # 完全保留原始参数和方程
        self.Nmax = 8000000  # 最大游客数（硬编码）
        self.CO2max = 250000  # 最大CO2排放量（吨）
        self.CO2p = 0.184  # 每位游客的CO2排放量（吨/人）
        self.Cbase = 500  # 基础环境容量
        self.Cwater = 18900000  # 水资源容量
        self.Cwaste = 2549110  # 废弃物容量
        self.Pt = 190  # 游客平均消费（美元/人）
        self.Restandrand = 500000000  # 收入标准化常数
